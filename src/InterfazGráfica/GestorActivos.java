...
public class GestorActivos {
    ...
    public void cargarEnemigos() {
        ...
        pj.enemigos[numeroMapa][i] = new EnemigoMediano(pj);
        pj.enemigos[numeroMapa][i].mundoX = pj.tamañoTile * 4; //12
        pj.enemigos[numeroMapa][i].mundoY = pj.tamañoTile * 4;  //7
        i++;

        pj.enemigos[numeroMapa][i] = new EnemigoMediano(pj);
        pj.enemigos[numeroMapa][i].mundoX = pj.tamañoTile * 13;  //5
        pj.enemigos[numeroMapa][i].mundoY = pj.tamañoTile * 14; //10
        i++;

        pj.enemigos[numeroMapa][i] = new EnemigoFinal(pj);
        pj.enemigos[numeroMapa][i].mundoX = pj.tamañoTile * 3;  //5
        pj.enemigos[numeroMapa][i].mundoY = pj.tamañoTile * 10;  //4
        i++;

        pj.enemigos[numeroMapa][i] = new EnemigoFinal(pj);
        pj.enemigos[numeroMapa][i].mundoX = pj.tamañoTile * 14; //14
        pj.enemigos[numeroMapa][i].mundoY = pj.tamañoTile * 7; //14
