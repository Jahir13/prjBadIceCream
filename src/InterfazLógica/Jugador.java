...
import InterfazGráfica.ManejadorTeclas;
...
public class Jugador extends Entidad {
    ...
    private void contactoConEnemigo(int enemigoIndex) {
        if (enemigoIndex != 999) {
            ...
            String nombreEnemigo = pj.enemigos[pj.mapaActual][enemigoIndex].nombre;

            switch (nombreEnemigo) {
                case "EnemigoBasico", "EnemigoMediano":
                    if (invencible == false) {
                        vida--;
                        invencible = true;
                    }
    ...
    public void construirHielo() {
        ...
        switch (direccion) {
            case "arriba":
                ...
                tileY = (mundoY - pj.tamañoTile + 1) / pj.tamañoTile;
                break;
            case "abajo":
                tileX = mundoX / pj.tamañoTile;
                tileY = (mundoY + pj.tamañoTile + 1) / pj.tamañoTile;
                break;
            case "izquierda":
                tileX = (mundoX - pj.tamañoTile + 1) / pj.tamañoTile;
                tileY = mundoY / pj.tamañoTile;
                break;
            case "derecha":
                tileX = (mundoX + pj.tamañoTile + 2) / pj.tamañoTile;
                tileY = mundoY / pj.tamañoTile;
                break;
        }
